...
"[project]/node_modules/json-bigint/lib/stringify.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/json-bigint/lib/parse.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/json-bigint/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$json$2d$bigint$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/json-bigint/index.js [app-client] (ecmascript)");
;
/******************************************************************************
...
const JSONbig$1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$json$2d$bigint$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
...
const JSONbigParser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$json$2d$bigint$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
    storeAsString: false
});
const JSONbigSerializer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$json$2d$bigint$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
    useNativeBigInt: true
});
 ...
 */ class Client {
        ...
        this.realtime = {
            ...
            createSocket: ()=>{
                ...
                ((_c = this.realtime.socket) === null || _c === void 0 ? void 0 : _c.readyState) > WebSocket.OPEN // Check if WebSocket is CLOSING (3) or CLOSED (4)
                    ...
                    if (this.realtime.socket && ((_d = this.realtime.socket) === null || _d === void 0 ? void 0 : _d.readyState) < WebSocket.CLOSING // Close WebSocket if it is CONNECTING (0) or OPEN (1)
                    ) {
                        this.realtime.reconnect = false;
    ...
    chunkedUpload(method_1, url_1) {
        return __awaiter(this, arguments, void 0, function*(method, url, headers = {}, originalPayload = {}, onProgress) {
            ...
            const firstChunkHeaders = Object.assign(Object.assign({}, headers), {
            ...
            firstPayload[fileParam] = new File([
                firstChunk
            ], file.name);
            ...
            const uploadChunk = (chunk)=>__awaiter(this, void 0, void 0, function*() {
                    ...
                    chunkPayload[fileParam] = new File([
                        chunkBlob
                    ], file.name);
...
class Realtime {
    ...
    subscribe(channelsOrChannel_1, callback_1) {
        return __awaiter(this, arguments, void 0, function*(channelsOrChannel, callback, queries = []) {
            const channelArray = Array.isArray(channelsOrChannel) ? channelsOrChannel : [
                channelsOrChannel
            ];
...
//# sourceMappingURL=node_modules_0jys4lw._.js.map