...
const ContactPage = () => {
  ...
  const inputClass = (field: keyof FormErrors, isPlaceholder = false): string =>
    `w-full bg-white/50 border rounded-2xl p-4 placeholder:text-slate-400 focus:outline-none focus:ring-2 transition-all font-medium ${
                  ...
                  <div className="space-y-1.5">
                    <div className="relative">
                      <select
                        ...
                        onChange={handleChange}
                        className={`${inputClass("subject", !formData.subject)} appearance-none cursor-pointer pr-10`}
                      >
