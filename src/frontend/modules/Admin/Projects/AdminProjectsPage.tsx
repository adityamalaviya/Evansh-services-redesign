...
const CATEGORIES = ["All", "Web Portals", "Websites", "Inventory Systems", "College Portals"];
...
export default function AdminProjectsPage() {
  ...
  const fetchProjects = useCallback(async () => {
    ...
    try {
      ...
      setError(formatApiError(err, "Could not load projects. Please check your BFF connection."));
    } finally {
      setIsLoading(false);
    }
  }, [filterCategory]);
