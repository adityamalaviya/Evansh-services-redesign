  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-[#1E1E24]">3D Printing Projects</h1>
          <p className="text-slate-500 text-sm mt-1">{projects.length} custom 3D models in portfolio</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/admin/projects/new?category=3D+Printing"
          ...
          >
            <Plus size={18} weight="bold" /> Add 3D Model
          </Link>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
        {isLoading ? (
          ...
          <div className="text-center py-20">
            <p className="text-slate-500 text-lg font-semibold mb-2">No 3D printing projects found</p>
            <p className="text-slate-400 text-sm mb-6">Add your first 3D printing project to get started.</p>
            <Link
              href="/admin/projects/new?category=3D+Printing"
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50">
                  <th className="text-left text-xs font-bold text-slate-400 uppercase tracking-widest px-6 py-4">3D Model</th>
