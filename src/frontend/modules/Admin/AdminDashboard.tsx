    ...
    <div className="space-y-8">
      ...
      <div className="bg-teal-50 border border-teal-100 rounded-2xl p-6">
        ...
        <p className="text-slate-500 text-sm leading-relaxed">
          Your admin panel is connected via the <span className="text-[#1E1E24] font-semibold">BFF and Pipeline services</span>.
          Items added or modified here will be validated by the Pipeline and published live on your website.
        </p>
      </div>
    </div>
  );
